...
class _SignUpFormState extends State<SignUpForm> {
                ...
                if (res == null) {
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      ...
                      content: Text("Couldn't verify this time.", style: buttonInsideText,),
                    ),
                  );
                  setState(() {
                    callDone = true;
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      ...
                      shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(20)),
                      content: Text("User Already Exists", style: buttonInsideText,),
                    ),
                  );
                  setState(() {
                    callDone = true;
  ...
  void navOtp() {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => OtpScreen(data: phonenumber,  EndPoint: user_verify),
      ),
    );
  }
